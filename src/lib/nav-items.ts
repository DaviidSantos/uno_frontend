    ...
    navlinks: [
      {
        ...
        description: "Cadastre um novo projeto de um cliente para o laboratório",
        href: "/solicitacao-analise/cadastrar",
      },
      {
        key: "uno-navlink-04",
        title: "Listar Solicitações de Análise",
        description: "Veja a listagem de todas as Solicitações de Análise feitas pelo laboratório",
